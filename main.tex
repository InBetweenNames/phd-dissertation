...
\begin{enumerate}
    ...
    \item A New Approach for Processing Natural-Language Queries to Semantic Web Triplestores (ACCEPTED) %TODO

    \item Accommodating Negation in an Efficient Event-Based Natural Language Query Interface to the Semantic Web (ACCEPTED) %TODO
\end{enumerate}
