...
\noindent All of the events of type ``discover'' are collected together and are checked to see if $\entityassoc{phobos}$ is found as the \textit{object} role value of any of them. If so \textit{True} is returned.
